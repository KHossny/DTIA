...
<br />
test_percent:                      percentage of the data taken as a test for the generated decision tree models. <br />
min_s_leaf_inc:                    increment in the minimum number of samples per leaf specified in the generated decision tree models. <br />
